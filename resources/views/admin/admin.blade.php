        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" method="post" action="{{ route('editUserPerssion', $user->id) }}">
                    ...
                    <div>
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Access</label>
                        <select type="text" name="access" value="{{ $user->access }}" id="name"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Title" required> 
                            <option disabled selected>{{ $user->access }}</option>
                            <option>RONLY</option>
                            <option>RW</option>
                            <option>RWX</option>
                        </select>
